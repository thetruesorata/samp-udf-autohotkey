...
# --------------------------------------------------------------------------------------------------------------------------- # 
#                                                                                                                             # 
#     - IsSAMPAvailable()                         Pr�ft, ob man in den Chat schreiben kann & ob GTA geladen ist               # 
...
#     - AddChatMessage(wText)                     F�gt eine Zeile in den Chat ein (nur f�r den Spieler sichtbar)              # 
...
# --------------------------------------------------------------------------------------------------------------------------- # 
#                                                                                                                             # 
#     - GetWeatherId()                            Gibt die aktuelle Wetter ID zur�ck                                          # 
#     - GetWeatherName()                          Gibt den aktuellen Wetternamen zur�ck                                       # 
#                                                                                                                             # 
# --------------------------------------------------------------------------------------------------------------------------- # 
#                                                                                                                             # 
...
#     - GetDialogLines__()                          Liest die Zeilen mittels GetDialogText aus (gibt ein Array zur�ck)          # 
...
#     - GetStreamedInPlayersInfo()                Zeigt Informationen �ber die gestreamten Spieler.                           # 
#     - CallFuncForAllStreamedInPlayers()         F�hrt bestimmte Funktionen, f�r die gestreamten Spieler aus.                # 
...
#     - GetPlayerArmor()                          Ermittelt den R�stungswert des Spielers                                     # 
...
#     - GetPlayerPos(X, Y, Z)                     siehe oben dr�ber                                                           # 
#                                                                                                                             # 
# --------------------------------------------------------------------------------------------------------------------------- # 
#                                                                                                                             # 
#     - InitZonesAndCities()                      Initialisiert eine Liste aller Standartgebiete                              # 
#                                                 (Voraussetzung f�r die folgenden Funktionen dieser Kategorie)               # 
...
#     - IsPlayerInRangeOfPoint(X, Y, Z, Radius)   Bestimmt ob der Spieler in der N�he der Koordinaten ist                     # 
#     - IsPlayerInRangeOfPoint2D(X, Y, Radius)    Bestimmt ob der Spieler in der N�he der Koordinaten ist                     # 
#     - GetPlayerZone()                                                                                                       # 
#     - GetPlayerCity()                                                                                                       # 
#                                                                                                                             # 
############################################################################################################################### 
...
# --------------------------------------------------------------------------------------------------------------------------- # 
#                                                                                                                             # 
#     - AntiCrash()                               Hilft gegen das abst�rzen bei Warningscodes                                 # 
#                                                                                                                             # 
############################################################################################################################### 
